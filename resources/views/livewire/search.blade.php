            ...
            <div class="px-4 py-3 space-y-1">
                @forelse ($products as $product)
                    <a href="{{ route('products.show', $product)}}" class="flex">
                        <img class="w-16 h-12 object-cover" src={{ Storage::url($product->images->first()->url) }} alt="" srcset="">
                ...
                @empty
                <p class="text-lg font-semibold leading-5">NO EXISTE NINGÚN REGISTRO CON LOS PARAMETROS ESPECIFICADOS</p>
                @endforelse
            </div>
        </div>
    </div>
